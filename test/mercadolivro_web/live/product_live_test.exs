defmodule MercadolivroWeb.ProductLiveTest do
  use MercadolivroWeb.ConnCase

  import Phoenix.LiveViewTest
  import Mercadolivro.StoreFixtures

  @create_attrs %{name: "some name", description: "some description", amount: 42, stock: 42, thumbnail: "some thumbnail"}
